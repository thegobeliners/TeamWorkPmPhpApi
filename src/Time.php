...
class Time extends Model
{
     ...
     * @return \TeamWorkPm\Response\Model
     */
    public function getTotalAll(array $params = [])
    {
        return $this->rest->get("time/total", $params);
    }
     ...
     * @return \TeamWorkPm\Response\Model
     */
    public function getTotalByProject($project_id, array $params = [])
    {
        $project_id = (int) $project_id;
        if ($project_id <= 0) {
            throw new Exception('Invalid param project_id');
     ...
     * @return \TeamWorkPm\Response\Model
     */
    public function getTotalByTask($task_id, array $params = [])
    {
        $task_id = (int) $task_id;
        if ($task_id <= 0) {
            throw new Exception('Invalid param task_id');
     ...
     * @return \TeamWorkPm\Response\Model
     */
    public function getTotalByTaskList($task_list_id, array $params = [])
    {
        $task_id = (int) $task_list_id;
        if ($task_id <= 0) {
